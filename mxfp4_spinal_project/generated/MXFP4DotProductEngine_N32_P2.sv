...
module AdderTree (
  ...
  wire       [12:0]   _zz__zz_io_result_4_1;
  wire       [12:0]   _zz__zz_io_result_5;
  wire       [12:0]   _zz__zz_io_result_5_1;
  wire       [12:0]   _zz__zz_io_result_6;
  wire       [12:0]   _zz__zz_io_result_6_1;
  wire       [12:0]   _zz__zz_io_result_7;
  wire       [12:0]   _zz__zz_io_result_7_1;
  wire       [12:0]   _zz__zz_io_result_8;
  wire       [12:0]   _zz__zz_io_result_8_1;
  wire       [12:0]   _zz__zz_io_result_9;
  wire       [12:0]   _zz__zz_io_result_9_1;
  ...
  reg        [12:0]   _zz_io_result_4;
  reg        [12:0]   _zz_io_result_5;
  reg        [12:0]   _zz_io_result_6;
  reg        [12:0]   _zz_io_result_7;
  reg        [12:0]   _zz_io_result_8;
  reg        [12:0]   _zz_io_result_9;

  assign _zz__zz_io_result = ($signed(extInputs_0) + $signed(extInputs_1));
  assign _zz__zz_io_result_1 = ($signed(extInputs_2) + $signed(extInputs_3));
  assign _zz__zz_io_result_1_1 = ($signed(extInputs_4) + $signed(extInputs_5));
  assign _zz__zz_io_result_1_2 = ($signed(extInputs_6) + $signed(extInputs_7));
  assign _zz__zz_io_result_2 = ($signed(extInputs_8) + $signed(extInputs_9));
  assign _zz__zz_io_result_2_1 = ($signed(extInputs_10) + $signed(extInputs_11));
  assign _zz__zz_io_result_3 = ($signed(extInputs_12) + $signed(extInputs_13));
  assign _zz__zz_io_result_3_1 = ($signed(extInputs_14) + $signed(extInputs_15));
  assign _zz__zz_io_result_4 = ($signed(extInputs_16) + $signed(extInputs_17));
  assign _zz__zz_io_result_4_1 = ($signed(extInputs_18) + $signed(extInputs_19));
  assign _zz__zz_io_result_5 = ($signed(extInputs_20) + $signed(extInputs_21));
  assign _zz__zz_io_result_5_1 = ($signed(extInputs_22) + $signed(extInputs_23));
  assign _zz__zz_io_result_6 = ($signed(extInputs_24) + $signed(extInputs_25));
  assign _zz__zz_io_result_6_1 = ($signed(extInputs_26) + $signed(extInputs_27));
  assign _zz__zz_io_result_7 = ($signed(extInputs_28) + $signed(extInputs_29));
  assign _zz__zz_io_result_7_1 = ($signed(extInputs_30) + $signed(extInputs_31));
  assign _zz__zz_io_result_8 = ($signed(_zz_io_result) + $signed(_zz_io_result_1));
  assign _zz__zz_io_result_8_1 = ($signed(_zz_io_result_2) + $signed(_zz_io_result_3));
  assign _zz__zz_io_result_9 = ($signed(_zz_io_result_4) + $signed(_zz_io_result_5));
  assign _zz__zz_io_result_9_1 = ($signed(_zz_io_result_6) + $signed(_zz_io_result_7));
  ...
  assign io_result = ($signed(_zz_io_result_8) + $signed(_zz_io_result_9));
  always @(posedge clk) begin
    _zz_io_result <= ($signed(_zz__zz_io_result) + $signed(_zz__zz_io_result_1));
    _zz_io_result_1 <= ($signed(_zz__zz_io_result_1_1) + $signed(_zz__zz_io_result_1_2));
    _zz_io_result_2 <= ($signed(_zz__zz_io_result_2) + $signed(_zz__zz_io_result_2_1));
    _zz_io_result_3 <= ($signed(_zz__zz_io_result_3) + $signed(_zz__zz_io_result_3_1));
    _zz_io_result_4 <= ($signed(_zz__zz_io_result_4) + $signed(_zz__zz_io_result_4_1));
    _zz_io_result_5 <= ($signed(_zz__zz_io_result_5) + $signed(_zz__zz_io_result_5_1));
    _zz_io_result_6 <= ($signed(_zz__zz_io_result_6) + $signed(_zz__zz_io_result_6_1));
    _zz_io_result_7 <= ($signed(_zz__zz_io_result_7) + $signed(_zz__zz_io_result_7_1));
    _zz_io_result_8 <= ($signed(_zz__zz_io_result_8) + $signed(_zz__zz_io_result_8_1));
    _zz_io_result_9 <= ($signed(_zz__zz_io_result_9) + $signed(_zz__zz_io_result_9_1));
  end
