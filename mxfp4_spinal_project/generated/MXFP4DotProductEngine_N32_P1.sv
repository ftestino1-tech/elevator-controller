...
module AdderTree (
  ...
  wire       [12:0]   _zz__zz_io_result;
  wire       [12:0]   _zz__zz_io_result_1;
  wire       [12:0]   _zz__zz_io_result_2;
  wire       [12:0]   _zz__zz_io_result_3;
  wire       [12:0]   _zz__zz_io_result_4;
  wire       [12:0]   _zz__zz_io_result_5;
  wire       [12:0]   _zz__zz_io_result_1_1;
  wire       [12:0]   _zz__zz_io_result_1_2;
  wire       [12:0]   _zz__zz_io_result_1_3;
  wire       [12:0]   _zz__zz_io_result_1_4;
  wire       [12:0]   _zz__zz_io_result_1_5;
  wire       [12:0]   _zz__zz_io_result_1_6;
  wire       [12:0]   _zz__zz_io_result_2_1;
  wire       [12:0]   _zz__zz_io_result_2_2;
  wire       [12:0]   _zz__zz_io_result_2_3;
  wire       [12:0]   _zz__zz_io_result_2_4;
  wire       [12:0]   _zz__zz_io_result_2_5;
  wire       [12:0]   _zz__zz_io_result_2_6;
  wire       [12:0]   _zz__zz_io_result_3_1;
  wire       [12:0]   _zz__zz_io_result_3_2;
  wire       [12:0]   _zz__zz_io_result_3_3;
  wire       [12:0]   _zz__zz_io_result_3_4;
  wire       [12:0]   _zz__zz_io_result_3_5;
  wire       [12:0]   _zz__zz_io_result_3_6;
  ...
  reg        [12:0]   _zz_io_result;
  reg        [12:0]   _zz_io_result_1;
  reg        [12:0]   _zz_io_result_2;
  reg        [12:0]   _zz_io_result_3;

  assign _zz__zz_io_result = ($signed(_zz__zz_io_result_1) + $signed(_zz__zz_io_result_2));
  assign _zz__zz_io_result_1 = ($signed(extInputs_0) + $signed(extInputs_1));
  assign _zz__zz_io_result_2 = ($signed(extInputs_2) + $signed(extInputs_3));
  assign _zz__zz_io_result_3 = ($signed(_zz__zz_io_result_4) + $signed(_zz__zz_io_result_5));
  assign _zz__zz_io_result_4 = ($signed(extInputs_4) + $signed(extInputs_5));
  assign _zz__zz_io_result_5 = ($signed(extInputs_6) + $signed(extInputs_7));
  assign _zz__zz_io_result_1_1 = ($signed(_zz__zz_io_result_1_2) + $signed(_zz__zz_io_result_1_3));
  assign _zz__zz_io_result_1_2 = ($signed(extInputs_8) + $signed(extInputs_9));
  assign _zz__zz_io_result_1_3 = ($signed(extInputs_10) + $signed(extInputs_11));
  assign _zz__zz_io_result_1_4 = ($signed(_zz__zz_io_result_1_5) + $signed(_zz__zz_io_result_1_6));
  assign _zz__zz_io_result_1_5 = ($signed(extInputs_12) + $signed(extInputs_13));
  assign _zz__zz_io_result_1_6 = ($signed(extInputs_14) + $signed(extInputs_15));
  assign _zz__zz_io_result_2_1 = ($signed(_zz__zz_io_result_2_2) + $signed(_zz__zz_io_result_2_3));
  assign _zz__zz_io_result_2_2 = ($signed(extInputs_16) + $signed(extInputs_17));
  assign _zz__zz_io_result_2_3 = ($signed(extInputs_18) + $signed(extInputs_19));
  assign _zz__zz_io_result_2_4 = ($signed(_zz__zz_io_result_2_5) + $signed(_zz__zz_io_result_2_6));
  assign _zz__zz_io_result_2_5 = ($signed(extInputs_20) + $signed(extInputs_21));
  assign _zz__zz_io_result_2_6 = ($signed(extInputs_22) + $signed(extInputs_23));
  assign _zz__zz_io_result_3_1 = ($signed(_zz__zz_io_result_3_2) + $signed(_zz__zz_io_result_3_3));
  assign _zz__zz_io_result_3_2 = ($signed(extInputs_24) + $signed(extInputs_25));
  assign _zz__zz_io_result_3_3 = ($signed(extInputs_26) + $signed(extInputs_27));
  assign _zz__zz_io_result_3_4 = ($signed(_zz__zz_io_result_3_5) + $signed(_zz__zz_io_result_3_6));
  assign _zz__zz_io_result_3_5 = ($signed(extInputs_28) + $signed(extInputs_29));
  assign _zz__zz_io_result_3_6 = ($signed(extInputs_30) + $signed(extInputs_31));
  assign _zz_io_result_4 = ($signed(_zz_io_result) + $signed(_zz_io_result_1));
  assign _zz_io_result_5 = ($signed(_zz_io_result_2) + $signed(_zz_io_result_3));
  ...
  assign io_result = ($signed(_zz_io_result_4) + $signed(_zz_io_result_5));
  always @(posedge clk) begin
    _zz_io_result <= ($signed(_zz__zz_io_result) + $signed(_zz__zz_io_result_3));
    _zz_io_result_1 <= ($signed(_zz__zz_io_result_1_1) + $signed(_zz__zz_io_result_1_4));
    _zz_io_result_2 <= ($signed(_zz__zz_io_result_2_1) + $signed(_zz__zz_io_result_2_4));
    _zz_io_result_3 <= ($signed(_zz__zz_io_result_3_1) + $signed(_zz__zz_io_result_3_4));
  end
