...
VMXFP4DotProductEngine::VMXFP4DotProductEngine(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , io_vecA_4{vlSymsp->TOP.io_vecA_4}
    , io_vecA_5{vlSymsp->TOP.io_vecA_5}
    , io_vecA_6{vlSymsp->TOP.io_vecA_6}
    , io_vecA_7{vlSymsp->TOP.io_vecA_7}
    ...
    , io_vecB_4{vlSymsp->TOP.io_vecB_4}
    , io_vecB_5{vlSymsp->TOP.io_vecB_5}
    , io_vecB_6{vlSymsp->TOP.io_vecB_6}
    , io_vecB_7{vlSymsp->TOP.io_vecB_7}
