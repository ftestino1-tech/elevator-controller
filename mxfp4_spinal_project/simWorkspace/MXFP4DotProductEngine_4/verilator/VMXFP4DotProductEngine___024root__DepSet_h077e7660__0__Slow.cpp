...
#endif
            VL_FATAL_MT("/home/fabio_testino/mxfp4_spinal_project/./simWorkspace/tmp/job_5/MXFP4DotProductEngine.v", 6, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VMXFP4DotProductEngine___024root___ctor_var_reset(VMXFP4DotProductEngine___024root* vlSelf) {
    ...
    vlSelf->MXFP4DotProductEngine__DOT__adderTree_1__DOT___zz_io_result_2 = VL_RAND_RESET_I(11);
