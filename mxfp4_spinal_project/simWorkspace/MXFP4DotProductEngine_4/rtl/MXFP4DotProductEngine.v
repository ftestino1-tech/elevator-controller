...
module MXFP4DotProductEngine (
  ...
  output wire [10:0]   io_dotProduct,
  ...
  wire       [10:0]   adderTree_1_io_result;
  wire       [10:0]   scaleIntegrator_io_dotProduct;
  ...
  AdderTree adderTree_1 (
    ...
    .io_result   (adderTree_1_io_result[10:0]), //o
    .clk         (clk                        ), //i
    .reset       (reset                      )  //i
  );
  SharedScaleIntegrator scaleIntegrator (
    .io_treeSum       (adderTree_1_io_result[10:0]          ), //i
    .io_scaleA        (io_scaleA[7:0]                       ), //i
    .io_scaleB        (io_scaleB[7:0]                       ), //i
    .io_dotProduct    (scaleIntegrator_io_dotProduct[10:0]  ), //o
...
module AdderTree (
  ...
  output wire [10:0]   io_result,
  input  wire          clk,
  input  wire          reset
);

  wire       [10:0]   _zz__zz_io_result;
  wire       [10:0]   _zz__zz_io_result_1;
  wire       [10:0]   _zz__zz_io_result_1_1;
  wire       [10:0]   _zz__zz_io_result_1_2;
  wire       [10:0]   extInputs_0;
  wire       [10:0]   extInputs_1;
  wire       [10:0]   extInputs_2;
  wire       [10:0]   extInputs_3;
  wire       [10:0]   extInputs_4;
  wire       [10:0]   extInputs_5;
  wire       [10:0]   extInputs_6;
  wire       [10:0]   extInputs_7;
  reg        [10:0]   _zz_io_result;
  reg        [10:0]   _zz_io_result_1;
  reg        [10:0]   _zz_io_result_2;
  ...
  assign extInputs_0 = {{3{io_inputs_0[7]}}, io_inputs_0};
  assign extInputs_1 = {{3{io_inputs_1[7]}}, io_inputs_1};
  assign extInputs_2 = {{3{io_inputs_2[7]}}, io_inputs_2};
  assign extInputs_3 = {{3{io_inputs_3[7]}}, io_inputs_3};
  assign extInputs_4 = {{3{io_inputs_4[7]}}, io_inputs_4};
  assign extInputs_5 = {{3{io_inputs_5[7]}}, io_inputs_5};
  assign extInputs_6 = {{3{io_inputs_6[7]}}, io_inputs_6};
  assign extInputs_7 = {{3{io_inputs_7[7]}}, io_inputs_7};
  assign io_result = _zz_io_result_2;
  always @(posedge clk) begin
    ...
    _zz_io_result_2 <= ($signed(_zz_io_result) + $signed(_zz_io_result_1));
  end
...
module ExponentAligner (
  ...
  assign expMax = ((io_exps_7 < _zz_expMax_5) ? _zz_expMax_5 : io_exps_7);
...
//MXFP4Multiplier_7 replaced by MXFP4Multiplier

//MXFP4Multiplier_6 replaced by MXFP4Multiplier

//MXFP4Multiplier_5 replaced by MXFP4Multiplier

//MXFP4Multiplier_4 replaced by MXFP4Multiplier
