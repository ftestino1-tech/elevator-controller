...
class Wrapper_8639848378365028878;
thread_local Wrapper_8639848378365028878 *simHandle8639848378365028878;
...
public:
    ...
    Wrapper_8639848378365028878(const char * name, const char * wavePath, int seed){
      //contextp = new VerilatedContext;
      Verilated::randReset(2);
      Verilated::randSeed(seed);
      top = new VMXFP4DotProductEngine();

      simHandle8639848378365028878 = this;
      time = 0;
      timeCheck = 0;
      ...
      signalAccess[4] = new CDataSignalAccess( top->io_vecB_0 );
      signalAccess[5] = new CDataSignalAccess( top->io_vecB_1 );
      signalAccess[6] = new CDataSignalAccess( top->io_vecB_2 );
      signalAccess[7] = new CDataSignalAccess( top->io_vecB_3 );
      signalAccess[8] = new CDataSignalAccess( top->io_scaleA );
      signalAccess[9] = new CDataSignalAccess( top->io_scaleB );
      signalAccess[10] = new SDataSignalAccess( top->io_dotProduct );
      signalAccess[11] = new SDataSignalAccess( top->io_combinedScale );
    ...
    virtual ~Wrapper_8639848378365028878(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/fabio_testino/mxfp4_spinal_project/./simWorkspace/MXFP4DotProductEngine/$TEST/") + name + ".dat").c_str());
      #endif
...
double sc_time_stamp () {
  return simHandle8639848378365028878->time;
}
...
JNIEXPORT Wrapper_8639848378365028878 * API JNICALL Java_wrapper_1verilator_VerilatorNative_newHandle_18639848378365028878
  (JNIEnv * env, jobject obj, jstring name, jstring wavePath, jint seedValue){
    ...
    Wrapper_8639848378365028878 *handle = new Wrapper_8639848378365028878(ch, wavePathCh, seedValue);
    env->ReleaseStringUTFChars(name, ch);
    env->ReleaseStringUTFChars(wavePath, wavePathCh);
    return handle;
}

JNIEXPORT jboolean API JNICALL Java_wrapper_1verilator_VerilatorNative_eval_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle){
   handle->top->eval();
   return Verilated::gotFinish();
}

JNIEXPORT jint API JNICALL Java_wrapper_1verilator_VerilatorNative_getTimePrecision_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle){
  return handle->time_precision;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_sleep_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle, uint64_t cycles){
  #ifdef TRACE
...
JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle, int id){
  return handle->signalAccess[id]->getU64();
}

JNIEXPORT jlong API JNICALL Java_wrapper_1verilator_VerilatorNative_getU64mem_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle, int id, uint64_t index){
  return handle->signalAccess[id]->getU64_mem(index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle, int id, uint64_t value){
  handle->signalAccess[id]->setU64(value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setU64mem_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 *handle, int id, uint64_t value, uint64_t index){
  handle->signalAccess[id]->setU64_mem(value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_deleteHandle_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 * handle){
  delete handle;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8_18639848378365028878
  (JNIEnv * env, jobject obj, Wrapper_8639848378365028878 * handle, jint id, jbyteArray value){
  handle->signalAccess[id]->getAU8(env, value);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_getAU8mem_18639848378365028878
  (JNIEnv * env, jobject obj, Wrapper_8639848378365028878 * handle, jint id, jbyteArray value, uint64_t index){
  handle->signalAccess[id]->getAU8_mem(env, value, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8_18639848378365028878
  (JNIEnv * env, jobject obj, Wrapper_8639848378365028878 * handle, jint id, jbyteArray value, jint length){
  handle->signalAccess[id]->setAU8(env, value, length);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_setAU8mem_18639848378365028878
  (JNIEnv * env, jobject obj, Wrapper_8639848378365028878 * handle, jint id, jbyteArray value, jint length, uint64_t index){
  handle->signalAccess[id]->setAU8_mem(env, value, length, index);
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_enableWave_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 * handle){
  handle->waveEnabled = true;
}

JNIEXPORT void API JNICALL Java_wrapper_1verilator_VerilatorNative_disableWave_18639848378365028878
  (JNIEnv *, jobject, Wrapper_8639848378365028878 * handle){
