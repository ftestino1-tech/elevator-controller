...
VElevatorController::VElevatorController(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , current_floor_sensor{vlSymsp->TOP.current_floor_sensor}
    , door_sensor{vlSymsp->TOP.door_sensor}
    , emergency{vlSymsp->TOP.emergency}
    , overload{vlSymsp->TOP.overload}
    , rst{vlSymsp->TOP.rst}
    , motor_up{vlSymsp->TOP.motor_up}
    , motor_down{vlSymsp->TOP.motor_down}
    , door_open{vlSymsp->TOP.door_open}
    , door_close{vlSymsp->TOP.door_close}
    , current_floor{vlSymsp->TOP.current_floor}
    , floor_request{vlSymsp->TOP.floor_request}
    , rootp{&(vlSymsp->TOP)}
{
