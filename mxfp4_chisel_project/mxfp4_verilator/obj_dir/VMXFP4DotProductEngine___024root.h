...
class alignas(VL_CACHE_LINE_BYTES) VMXFP4DotProductEngine___024root final : public VerilatedModule {
  public:
    ...
    CData/*7:0*/ MXFP4DotProductEngine__DOT___aligner_io_aligned_0;
    CData/*7:0*/ MXFP4DotProductEngine__DOT___aligner_io_aligned_1;
    CData/*7:0*/ MXFP4DotProductEngine__DOT___aligner_io_aligned_2;
    CData/*7:0*/ MXFP4DotProductEngine__DOT___aligner_io_aligned_3;
    CData/*2:0*/ MXFP4DotProductEngine__DOT___multipliers_3_io_expOut;
    CData/*2:0*/ MXFP4DotProductEngine__DOT___multipliers_2_io_expOut;
    CData/*2:0*/ MXFP4DotProductEngine__DOT___multipliers_1_io_expOut;
    CData/*2:0*/ MXFP4DotProductEngine__DOT___multipliers_0_io_expOut;
    CData/*2:0*/ MXFP4DotProductEngine__DOT__aligner__DOT__expMax;
    CData/*7:0*/ MXFP4DotProductEngine__DOT__aligner__DOT__shifted;
    CData/*7:0*/ MXFP4DotProductEngine__DOT__aligner__DOT__shifted_1;
    CData/*7:0*/ MXFP4DotProductEngine__DOT__aligner__DOT__shifted_2;
    CData/*7:0*/ MXFP4DotProductEngine__DOT__aligner__DOT__shifted_3;
