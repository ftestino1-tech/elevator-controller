...
REM
REM Generated by Vivado on Tue Mar 31 11:46:33 +0200 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_MXFP4_N4_P0_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_MXFP4_N4_P0_vlog.prj -log xvlog.log
