...
module AdderTree(
  ...
  reg [14:0] io_result_nextLevel_0_1;
  reg [14:0] io_result_nextLevel_1_1;
  reg [14:0] io_result_nextLevel_2_1;
  reg [14:0] io_result_nextLevel_3_1;
  reg [14:0] io_result_nextLevel_4_1;
  reg [14:0] io_result_nextLevel_5_1;
  reg [14:0] io_result_nextLevel_6_1;
  reg [14:0] io_result_nextLevel_7_1;
  reg [16:0] io_result_nextLevel_0_3;
  reg [16:0] io_result_nextLevel_1_3;
  always @(posedge clock) begin
    ...
    automatic logic [8:0]  _GEN_3 =
      {io_inputs_9[7], io_inputs_9} + {io_inputs_8[7], io_inputs_8};
    automatic logic [8:0]  _GEN_4 =
      {io_inputs_11[7], io_inputs_11} + {io_inputs_10[7], io_inputs_10};
    automatic logic [8:0]  _GEN_5 =
      {io_inputs_13[7], io_inputs_13} + {io_inputs_12[7], io_inputs_12};
    automatic logic [8:0]  _GEN_6 =
      {io_inputs_15[7], io_inputs_15} + {io_inputs_14[7], io_inputs_14};
    automatic logic [8:0]  _GEN_7 =
      {io_inputs_17[7], io_inputs_17} + {io_inputs_16[7], io_inputs_16};
    automatic logic [8:0]  _GEN_8 =
      {io_inputs_19[7], io_inputs_19} + {io_inputs_18[7], io_inputs_18};
    automatic logic [8:0]  _GEN_9 =
      {io_inputs_21[7], io_inputs_21} + {io_inputs_20[7], io_inputs_20};
    automatic logic [8:0]  _GEN_10 =
      {io_inputs_23[7], io_inputs_23} + {io_inputs_22[7], io_inputs_22};
    automatic logic [8:0]  _GEN_11 =
      {io_inputs_25[7], io_inputs_25} + {io_inputs_24[7], io_inputs_24};
    automatic logic [8:0]  _GEN_12 =
      {io_inputs_27[7], io_inputs_27} + {io_inputs_26[7], io_inputs_26};
    automatic logic [8:0]  _GEN_13 =
      {io_inputs_29[7], io_inputs_29} + {io_inputs_28[7], io_inputs_28};
    automatic logic [8:0]  _GEN_14 =
      {io_inputs_31[7], io_inputs_31} + {io_inputs_30[7], io_inputs_30};
    automatic logic [9:0]  _GEN_15 = {_GEN_0[8], _GEN_0} + {_GEN[8], _GEN};
    automatic logic [9:0]  _GEN_16 = {_GEN_2[8], _GEN_2} + {_GEN_1[8], _GEN_1};
    automatic logic [9:0]  _GEN_17 = {_GEN_4[8], _GEN_4} + {_GEN_3[8], _GEN_3};
    automatic logic [9:0]  _GEN_18 = {_GEN_6[8], _GEN_6} + {_GEN_5[8], _GEN_5};
    automatic logic [9:0]  _GEN_19 = {_GEN_8[8], _GEN_8} + {_GEN_7[8], _GEN_7};
    automatic logic [9:0]  _GEN_20 = {_GEN_10[8], _GEN_10} + {_GEN_9[8], _GEN_9};
    automatic logic [9:0]  _GEN_21 = {_GEN_12[8], _GEN_12} + {_GEN_11[8], _GEN_11};
    automatic logic [9:0]  _GEN_22 = {_GEN_14[8], _GEN_14} + {_GEN_13[8], _GEN_13};
    automatic logic [15:0] io_result_nextLevel_0_2 =
      {io_result_nextLevel_0_1[14], io_result_nextLevel_0_1}
      + {io_result_nextLevel_1_1[14], io_result_nextLevel_1_1};
    automatic logic [15:0] io_result_nextLevel_1_2 =
      {io_result_nextLevel_2_1[14], io_result_nextLevel_2_1}
      + {io_result_nextLevel_3_1[14], io_result_nextLevel_3_1};
    automatic logic [15:0] io_result_nextLevel_2_2 =
      {io_result_nextLevel_4_1[14], io_result_nextLevel_4_1}
      + {io_result_nextLevel_5_1[14], io_result_nextLevel_5_1};
    automatic logic [15:0] io_result_nextLevel_3_2 =
      {io_result_nextLevel_6_1[14], io_result_nextLevel_6_1}
      + {io_result_nextLevel_7_1[14], io_result_nextLevel_7_1};
    io_result_nextLevel_0_1 <= {{5{_GEN_15[9]}}, _GEN_15};
    io_result_nextLevel_1_1 <= {{5{_GEN_16[9]}}, _GEN_16};
    io_result_nextLevel_2_1 <= {{5{_GEN_17[9]}}, _GEN_17};
    io_result_nextLevel_3_1 <= {{5{_GEN_18[9]}}, _GEN_18};
    io_result_nextLevel_4_1 <= {{5{_GEN_19[9]}}, _GEN_19};
    io_result_nextLevel_5_1 <= {{5{_GEN_20[9]}}, _GEN_20};
    io_result_nextLevel_6_1 <= {{5{_GEN_21[9]}}, _GEN_21};
    io_result_nextLevel_7_1 <= {{5{_GEN_22[9]}}, _GEN_22};
    io_result_nextLevel_0_3 <=
      {io_result_nextLevel_0_2[15], io_result_nextLevel_0_2}
      + {io_result_nextLevel_1_2[15], io_result_nextLevel_1_2};
    io_result_nextLevel_1_3 <=
      {io_result_nextLevel_2_2[15], io_result_nextLevel_2_2}
      + {io_result_nextLevel_3_2[15], io_result_nextLevel_3_2};
  end // always @(posedge)
  assign io_result = io_result_nextLevel_0_3[12:0] + io_result_nextLevel_1_3[12:0];
endmodule
