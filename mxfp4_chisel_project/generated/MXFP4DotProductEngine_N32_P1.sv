...
module AdderTree(
  ...
  reg [15:0] io_result_nextLevel_0_2;
  reg [15:0] io_result_nextLevel_1_2;
  reg [15:0] io_result_nextLevel_2_2;
  reg [15:0] io_result_nextLevel_3_2;
  always @(posedge clock) begin
    ...
    automatic logic [10:0] _GEN_23 = {_GEN_16[9], _GEN_16} + {_GEN_15[9], _GEN_15};
    automatic logic [10:0] _GEN_24 = {_GEN_18[9], _GEN_18} + {_GEN_17[9], _GEN_17};
    automatic logic [10:0] _GEN_25 = {_GEN_20[9], _GEN_20} + {_GEN_19[9], _GEN_19};
    automatic logic [10:0] _GEN_26 = {_GEN_22[9], _GEN_22} + {_GEN_21[9], _GEN_21};
    io_result_nextLevel_0_2 <= {{5{_GEN_23[10]}}, _GEN_23};
    io_result_nextLevel_1_2 <= {{5{_GEN_24[10]}}, _GEN_24};
    io_result_nextLevel_2_2 <= {{5{_GEN_25[10]}}, _GEN_25};
    io_result_nextLevel_3_2 <= {{5{_GEN_26[10]}}, _GEN_26};
  end // always @(posedge)
  assign io_result =
    io_result_nextLevel_0_2[12:0] + io_result_nextLevel_1_2[12:0]
    + io_result_nextLevel_2_2[12:0] + io_result_nextLevel_3_2[12:0];
endmodule
